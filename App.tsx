...
const App = () => {
        ...
        try {
            ...
            const metadata = {
                ...
                "其他角色": [
                    ...
                    { "角色介紹": "孟詩涵，30歲，臺大醫院外科醫生。身高170公分，專業冷靜，私下優雅，略帶潔癖。" },
    ...
    const handlePlayTts = useCallback(async () => {
        ...
        try {
            ...
            let voiceName = voiceMap.ririka; // 默認為
