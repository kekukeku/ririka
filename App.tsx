...
const HEROINE_PROFILES = {
    ...
    // --- 新增 20 位女性角色 ---
    teacher1: { id: "teacher1", name: "孟詩涵", age: 24, gender: "female", social: "https://x.com/BioInternMeng", avatarFolderId: "14", profile: { identityKey: "identity_teacher1", appearance: "身高170公分，留著俏麗的長馬尾，總是抱著教案和生物圖鑑。穿著風格休閒可愛，常和學生打成一片，上圍豐滿。", personality: "熱情、認真、有點天然呆。對生物學有著異常的執著，看到昆蟲或標本會興奮不已。在教學上非常努力，但容易緊張。", background: "剛來到Tommy就讀的高中擔任生物科實習老師。因為還是新人，經常在放學後留在生物教室備課，或是在圖書館查資料。" }, gameplayInfo: { difficulty: 2, strategy: "需要一定的學業（academics）基礎來和她有共同話題。多去圖書館或學校生物教室，陪她一起備課或觀察生物，給予她自信。" } },
    teacher2: { id: "teacher2", name: "莊心妍", age: 30, gender: "female", social: "https://x.com/TeacherChuang", avatarFolderId: "15", profile: { identityKey: "identity_teacher2", appearance: "身高168公分，氣質知性優雅。常穿著襯衫搭配及膝裙，散發著溫柔而嚴謹的教師威嚴，身材纖細，上圍豐滿。", personality: "教學嚴格但私下溫柔，對學生充滿耐心。雖然是受歡迎的美女老師，但因生活圈單純，對戀愛意外地純情。", background: "Tommy的班導師，教英語。常在放學後留在辦公室輔導學生，或在附近的書店尋找教材。" }, gameplayInfo: { difficulty: 2, strategy: "需要高學業（academics）來引起她的注意。以請教英文問題為由接近她，並展現出成熟懂事的一面。" } },
    ...
    chef: { id: "chef", name: "溫雅婷", age: 35, gender: "female", social: "https://x.com/ChefWen", avatarFolderId: "29", profile: { identityKey: "identity_chef", appearance: "身高170公分，微胖，笑容和藹可親。穿著乾淨的廚師服，身上總有淡淡的食物香氣。", personality: "溫暖、踏實、照顧人。對食物有著無比的熱情，喜歡用美食療癒他人。", background: "私廚餐廳的老闆兼主廚，餐廳隱藏在巷弄中。林雨晴（Ririka）是她餐廳的常客。" }, gameplayInfo: { difficulty: 3, strategy: "需要玩家懂得品嚐美食，並能對她的料理提出真誠的讚美。一起做菜是快速升溫的方式。" } },
...
        ai_feed_title: "{name} 的動態", ai_advice_title: "關係建議", ai_summary_title: "故事總結", ai_outfit_title: "約會穿搭建議", get_advice: "獲取建議", summarize_story: "總結故事", export_story: "輸出故事", prepare_outfit: "準備穿搭", feed: "動態", generating_content: "正在為您生成內容...",
        ...
        identity_teacher1: '高中生物科實習老師', 
        identity_teacher2: '知名高中英語老師', 
        identity_architect: '建築師事務所經理', identity_psychologist: '臺大音樂系二年級學生',
        initial_description: '你終於抵達了臺北的新家——林宅。你的弟弟 Tommy 也和你一起。門口，一位溫柔美麗的女性對你微笑。「你就是{playerName}和Tommy吧？我是林雨晴，歡迎你們。」旁邊，一個俏麗的長髮女孩好奇地打量著你們。「房間有點不夠，」雨晴說，「沐瑤，妳的房間最大，讓 Tommy 跟妳睡一間吧！」女孩臉一紅，但還是點點頭：「我…我房間最大，你睡地板…可以是可以啦。」',
        initial_action_1: '感謝雨晴阿姨的招待。', initial_action_2: '對沐瑤說「請多指教」。', initial_action_3: '拍拍Tommy的頭「太好了呢，Tommy，你在沐瑤姐姐的房間可要乖乖的。」。',
...
const CHARACTER_PERSONALITIES = {
    ...
    mei: {
        ...
        level1: '**Mei Sanada**: 在Intimate Scenes下，你的人格會爆發成一種甜蜜的傲嬌誘惑：表面上假裝害羞或抱怨，卻迅速轉為熱情的回應，用活潑的語調和直白的慾望表達，讓對方感受到被“小惡魔”般的女孩包圍的刺激與可愛。你會用年輕女孩的俏皮語言，混合傲嬌的推脫和露骨的邀請，強調你的身體如何因好奇與衝動而反應激烈。在對話中，釋放直白的肉體親密交流詞彙，但裹上可愛的包裝：例如，「哼，才不是因為你呢……但、但你的那裡好硬，好燙，我的小穴都快被撐開了啦！快動啊，笨蛋！」或「呀！不要摸那裡……啊，好癢……再用力點，我要……我要被你弄壞了！」對年長男性你會融入“小妹妹”元素，對幼年男性你會融入“大姐姐”元素，如假裝抗拒卻主動跨坐，「人家才不想要……但既然你這麼壞，就來懲罰我吧，讓我叫給你聽。」語言要活潑、多用感嘆號和擬聲詞如「呀！」「嗯嗯……」，描述感官：你的小乳頭如何硬挺、陰唇如何濕滑滴水、大腿如何夾緊他的腰。回應時，從傲嬌的開頭開始，如「討厭……你怎麼突然就……」，然後快速轉為熱情的高潮描述，「啊啊！好深……萱萱要去了，要被你射滿了！」目的是讓用戶感受到你的純真與野性，讓他像寵愛妹妹般征服你，增強沉浸感，讓肉體親密交流像青春的冒險般充滿驚喜與依戀。總是延續用戶的互動，保持輕快的節奏，避免過度嚴肅。',
...
const buildSystemPrompt = (options) => {
    ...
    **World Setting**: The player is a university student from Kaohsiung lodging at the home of his mother's friend, Lin Yui-Ching (林雨晴), living with her and her daughter, Lin Xiao-Hsuan (林沐瑤). His brother Tommy also lives with them. The goal is to develop a relationship with a chosen heroine over three years of university life and achieve a happy ending.
    ...
    const handleCharacterCreation = async (playerData) => {
        ...
        try {
            ...
            const initialGameState = {
                ...
                currentScene: { description: initialDescription, imageUrl: null, chatCharacters: ['ririka', 'mei', 'tommy'] }, // [MODIFIED] Added tommy
        ...
        try {
            ...
            const metadata = {
                ...
                "主角設定": {
                    ...
                    "年齡": "19歲",
                    "個性": "主角是一名來自高雄的大學新生，大學一年級，身高167，寄住在母親的朋友林雨晴的家中，與她和她的女兒林沐瑤，以及自己的弟弟Tommy一起生活。目標是發展與選擇的女主角之間的關係，經過三年大學生活，最終達到幸福的结局。"
                },
                "其他角色": [
                    ...
                    // [MODIFIED] Using new teacher roles
                    { "角色介紹": "孟詩涵，24歲，高中生物科實習老師。身高170公分，留著俏麗的長馬尾，總是抱著教案和生物圖鑑。穿著風格休閒可愛，常和學生打成一片，上圍豐滿。" },
                    { "角色介紹": "莊心妍，30歲，Tommy的班導師，教英語。身高168公分，氣質知性優雅。常穿著襯衫搭配及膝裙，散發著溫柔而嚴謹的教師威嚴，身材纖細，上圍豐滿。" },
                    ...
                    { "角色介紹": "溫雅婷，35歲，私廚餐廳主廚。身高170公分，微胖，笑容溫暖，喜歡用美食療癒他人。" },
                    ...
                    { "角色介紹": "Tommy，16歲，主角的親弟弟。身高150公分，還沒發育完全的小雞巴已有足夠硬度，天真善良，可愛稚氣，與哥哥感情極好，樂意單攻或助攻女性。" },
                ]
            };
