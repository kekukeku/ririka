...
const HEROINE_PROFILES = {
    ...
    // --- 新增 20 位女性角色 ---
    teacher1: { id: "teacher1", name: "孟詩涵", age: 24, gender: "female", social: "https://x.com/BioInternMeng", avatarFolderId: "14", profile: { identityKey: "identity_teacher1", appearance: "身高170公分，留著俏麗的長馬尾，總是抱著教案和生物圖鑑。穿著風格休閒可愛，常和學生打成一片，上圍豐滿。", personality: "熱情、認真、有點天然呆。對生物學有著異常的執著，看到昆蟲或標本會興奮不已。在教學上非常努力，但容易緊張。", background: "剛來到Kevin就讀的高中擔任生物科實習老師。因為還是新人，經常在放學後留在生物教室備課，或是在圖書館查資料。" }, gameplayInfo: { difficulty: 2, strategy: "需要一定的學業（academics）基礎來和她有共同話題。多去圖書館或學校生物教室，陪她一起備課或觀察生物，給予她自信。" } },
        ...
        try {
            ...
            const metadata = {
                ...
                "主角設定": {
                    ...
                    "年齡": "20歲",
                    "個性": "主角是一名來自高雄升二年級大學轉學生，身高167，寄住在母親的朋友林雨晴的家中，與她和她的女兒林沐瑤，以及自己的弟弟Kevin一起生活。目標是發展與選擇的女主角之間的關係，經過三年大學生活，最終達到幸福的结局。"
                },
                "其他角色": [
                    ...
                    { "角色介紹": "孟詩涵，24歲，高中生物科實習老師。身高170公分，紮著長長的馬尾，熱情認真喜歡和學生打成一片，對生物學充滿狂熱。" },
                    { "角色介紹": "莊心妍，30歲，高中英語老師。身高168公分，氣質知性，教學嚴格但私下溫柔。" },
